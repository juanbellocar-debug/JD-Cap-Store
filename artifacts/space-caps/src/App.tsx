...
function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg shadow-[#25D366]/40 hover:bg-[#1ebe5d] hover:scale-110 transition-all duration-200"
      style={{ boxShadow: "0 0 0 3px rgba(37,211,102,0.18), 0 4px 20px rgba(37,211,102,0.35)" }}
    >
